    ...
    return (
      <div className="home-page" style={{marginTop: '1rem'}}>
        <Row className="laixe-listDO-Wr" style={{paddingTop: '0.3rem', paddingBottom: '1rem'}}>
          <h2 className="textCenter" style={{fontSize: '0.8rem', paddingBottom: '0.3rem'}}>Lệnh lái xe chưa nhận</h2>
          {this.state.init && (
              <div>
                        ...
                        {/*</div>*/}
                          <div>
                            ...
                            <div style={{fontSize: '16px'}}>
                              ...
                              <br/>
                              Lái xe: <b style={{}}> {el.laixe[0].name}</b>
                              <br/>
                              Biển kiểm soát: <b style={{color: 'red'}}> XXX-XXXXX </b>
                              <br/>
